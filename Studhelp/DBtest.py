...
def save_thread(subcat, name, text, category, user):  
    ...
    add_thread = ("INSERT INTO trådar "
               "(Namn, Beskrivning, UnderkategoriNamn, Kategorinamn, Användare) "
               "VALUES (%s, %s, %s, %s, %s)")
    thread_data = (name, text, subcat, category, user)
...
def create_new_thread(category, subcat):
    ...
    save_thread(subcat, name, text, category, user)
